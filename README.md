...
| 22.12.18 | PyTorch | V | [PTM] 4장. 실제 데이터를 텐서로 표현하기 <br> [PTM] 5장. 학습 기법 | [Facial Keypoint Detection 필사](https://www.kaggle.com/code/karanjakhar/facial-keypoint-detection) |
| 22.12.25 | PyTorch | - | [PTM] 6장. 신경망을 활용한 데이터 적합 <br> [PTM] 7장. 새와 비행기 구별하기: 이미지 학습 | [예술 작품 화가 분류 AI 경진대회](https://dacon.io/competitions/official/236006/codeshare/7077?page=1&dtype=recent) |
| 23.01.01 | PyTorch | - | - | - |
